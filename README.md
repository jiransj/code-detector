...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-v1.2-brightgreen.svg" alt="Version v1.2">
...
**code-detector** 从 v0.8 起支持 [MCP（Model Context Protocol）](https://modelcontextprotocol.io/) 服务器模式，让 AI 客户端（如 Claude Desktop）可以直接与 code-detector 交互，实时查询项目函数数据。
